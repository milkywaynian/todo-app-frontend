            ...
            <li>
              {
                this.props.allTasks.map(
                  (taskOption) => <ListItem key={taskOption.id} item={taskOption} deleteTaskFunc={this.props.deleteTaskFunc} completeTaskFunc={this.props.completeTaskFunc} checked={this.props.checked}/>

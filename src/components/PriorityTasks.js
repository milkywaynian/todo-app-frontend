...
class PriorityTasks extends React.Component {
    ...
    render() {
        ...
        <>
            <PriorityHeader />
            <PriorityItems allTasks = {this.props.allTasks} deleteTaskFunc ={this.props.deleteTaskFunc} completeTaskFunc={this.props.completeTaskFunc} checked={this.props.checked}/>
            <AddANewItemHeader />
